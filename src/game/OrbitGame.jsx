...
export default function OrbitGame() {
  ...
  useEffect(() => {
    ...
    if (game?.phase === 'resolved' || game?.phase === 'finished') { audio.current?.cue('impact'); audio.current?.cue(game.reveal.eliminated ? 'dead' : 'safe'); }
